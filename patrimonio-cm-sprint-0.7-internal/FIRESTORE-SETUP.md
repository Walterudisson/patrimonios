# Firestore — configuração segura da Sprint 0.7
...
As regras da Sprint 0.7 são iguais às da Sprint 0.6. Se o arquivo da Sprint 0.6 já foi publicado integralmente, não é necessário republicá-lo nesta etapa.
