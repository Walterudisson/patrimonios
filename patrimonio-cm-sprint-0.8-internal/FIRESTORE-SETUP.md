# Firestore — configuração segura da Sprint 0.8
...
As regras da Sprint 0.8 são iguais às da Sprint 0.6. Esta sprint altera somente câmera e leitura no cliente. Se as regras da Sprint 0.6 ou 0.7 já foram publicadas integralmente, não é necessário republicá-las nesta etapa.
