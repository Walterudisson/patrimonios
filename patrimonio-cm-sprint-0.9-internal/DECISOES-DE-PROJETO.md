...
- Após código de barras ou OCR reconhecer uma plaqueta, o scanner pausa, preserva uma imagem estática e rola até o painel de resultado posicionado imediatamente antes do formulário.
- A moldura e o texto sobrepostos à imagem congelada confirmam a região de leitura e o número reconhecido. Eles não representam uma caixa delimitadora exata calculada por visão computacional como em sistemas ALPR.
- Depois de cinco segundos sem resultado, o app oferece `Usar OCR`, `Digitar plaqueta` e `Continuar tentando`. A simples exibição dessa ajuda não interrompe o scanner.
...
- Redesenhar a navegação principal para funcionar bem nos dois contextos: menu hambúrguer com painel lateral no mobile e sidebar responsiva/recolhível no desktop.
- Manter na navegação somente as opções autorizadas ao perfil, indicar claramente a tela ativa e preservar uma barra superior compacta para identidade e dados do usuário.
