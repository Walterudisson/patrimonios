# Firestore — configuração segura da Sprint 1.0
...
As regras da Sprint 1.0 são idênticas às da Sprint 0.9. Esta sprint altera navegação, layout, feedback e organização visual da Fila, sem mudar permissões ou operações do Firestore. Se as regras anteriores já foram publicadas integralmente, não é necessário republicá-las nesta etapa.
...
- O painel de métricas locais foi removido na Sprint 1.0; consulte o Console do Firebase como fonte oficial de uso e faturamento.
