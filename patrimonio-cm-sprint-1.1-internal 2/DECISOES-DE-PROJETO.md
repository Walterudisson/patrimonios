...
- Sprint 1.1: perfil, foto, alteração da própria senha e redefinição de senha pelo Administrador concluídos em `v1.11.0`; falso feedback de erro na troca de senha corrigido em `v1.11.1`.
