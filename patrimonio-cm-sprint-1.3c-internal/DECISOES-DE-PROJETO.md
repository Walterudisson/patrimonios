...
- Na `v1.13.3`, a aba também oferece uma visão de progresso por divisão para Conferentes, limitada às divisões atribuídas e sem ações administrativas. Gestores e Administradores consultam todas as divisões. A porcentagem considera somente os itens do local efetivo; entradas pendentes aparecem à parte até a aprovação. Esses números representam o estado atual, não uma fotografia histórica persistida.
